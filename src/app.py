...
def confugure_interface():
    ...
    if uploaded_file is not None:
        ...
        if blob_url is not None:
            st.write(f"Arquivo {fileName} enviado para o Azure Blob Storage com URL")
            credit_card_info = analize_credit_card(blob_url)
            show_image_and_validation(blob_url, credit_card_info)
        else:
            st.write("Falha ao enviar o arquivo para o Azure Blob Storage")
